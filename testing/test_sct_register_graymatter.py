...
def test(path_data, parameters=''):
    ...
    if not parameters:
        parameters = ' -t-gm mt/label/template/PAM50_gm.nii.gz -t-wm mt/label/template/PAM50_gm.nii.gz -w mt/warp_template2mt.nii.gz -gm mt/mt1_gmseg.nii.gz -wm mt/mt1_wmseg.nii.gz -manual-gm mt/mt1_gmseg_goldstandard.nii.gz -sc mt/mt1_seg.nii.gz -qc 0' #-d mt/mt0.nii.gz
